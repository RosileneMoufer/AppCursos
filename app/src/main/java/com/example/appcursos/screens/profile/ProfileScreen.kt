...
fun Body(navController: NavController, logOutAction: () -> Unit) {
    ...
    Column(
        ...
        Column(
            ...
            SwitchButton(
                {profileViewModel.isPostActive.value = true},
                {profileViewModel.isPostActive.value = false},
                profileViewModel.isPostActive.value
            )

            Spacer(modifier = Modifier.height(16.dp))

            if (profileViewModel.isPostActive.value) {
